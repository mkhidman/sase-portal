import { CheckCircle2, Download, FileText, Pencil, Plus, Search, Users, X } from 'lucide-react'
    ...
    return (
      <>
        ...
        <article className="card meeting-form-card">
          ...
          <div className="section-heading meeting-content-heading"><div><h2>Tindak lanjut keputusan</h2><p>Setiap tugas dapat diberi penanggung jawab dari peserta dan tenggat waktu.</p></div><button className="button soft small" type="button" onClick={() => setForm((current) => current ? { ...current, actions: [...current.actions, blankAction(current.note.id)] } : current)}><Plus size={14} /> Tambah tugas</button></div>
